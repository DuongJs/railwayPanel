namespace RailwayPanel
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Справочное табло железнодрожного вокзала";
            ...
            this.labelCopyright.Text = "Авторские права: Кириллов Никита БИ-18-1";
            ...
            this.labelCompanyName.Text = "НИУ ВШЭ-Пермь";
            this.labelCompanyName.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // textBoxDescription
            // 
            this.textBoxDescription.AutoCompleteCustomSource.AddRange(new string[] {
            "Программа разработана для работы справочного табло железнодорожного вокзала."});
